...
* `HOSTNAME_HTTPS`: this is basically the host part of the "my-release" Route that will be created by this HELM Chart for your application, e.g. `my-release-mytestns.apps.my-cluster-base-url`; set its value with e.g. (note we replace "keycloak-" with "my-release-"):
